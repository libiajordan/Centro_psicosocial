...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/estilo_medico.css">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Psicologos</h6>
                </nav>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Registrar Psicologos</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="container">
                                <h6>Registro de Psicologos</h6>

                                <!-- Botón para abrir el formulario -->
                                <button id="openFormBtn" class="styled-button">Crear Psicologo</button>    
                                ...
                                <div id="myModal" class="modal"> 
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="card">  
                                            <div class="card-body"> 
                                                <h6>Crear Nuevo Psicologo</h6>
                                                <form id="formulario" method="POST" action="guardar_medico.php">
                                                    <label for="nombre">Nombre y Apellido:</label>
                                                    <input type="text" id="nombre" name="nombre_medico" required>
                                                    <label for="numero_telefono">Telefono:</label>
                                                    <input type="text" id="telefono" name="telefono" required>
                                                    <label for="email">Correo electronico:</label>
                                                    <input type="text" id="email" name="email" required>
                                                    <label for="tarjeta">Tarjeta profesional:</label>
                                                    <input type="text" id="tarjeta" name="tarjeta_profesional" required>
                                                    
                                                    <?php include 'paciente_select.php'; ?>
                                        
                                                    <br><br>

                                                    <button type="submit">Guardar Psicologo</button>
