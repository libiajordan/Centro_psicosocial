            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Seguimiento - Pacientes</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Sesiones</h6>
                </nav>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Registrar Seguimiento de Sesión</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="container">
                                <h6>Registro de Sesión</h6>

                                <!-- Botón para abrir el formulario -->
                                <button id="openFormBtn" class="styled-button" onclick="toggleFormulario()">Crear seguimiento</button>
 

                                <!-- Formulario para registrar sesión -->
                                <form method="post" action="registrar_sesion.php" id="registroForm" class="d-none">
                                    ...
                                    <textarea id="objetivos" name="objetivos" rows="4" cols="67" required></textarea>

                                    <label for="estado_paciente">Estado del Paciente:</label>
                                    <textarea id="estado_paciente" name="estado_paciente" rows="4" cols="67" required></textarea>

                                    <label for="tareas">Tareas para el Paciente:</label>
                                    <textarea id="tareas" name="tareas" rows="4" cols="67" required></textarea>

                                    <button type="submit" name="crear_seguimiento">Crear Seguimiento</button>
                                </form>
