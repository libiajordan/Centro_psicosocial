...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/estilo_paciente.css">
    <!-- Font Awesome Icons -->
...
<body class="g-sidenav-show  bg-gray-200">
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Registrar pacientes</h6>
                            </div>
                        </div>

                        <div class="card-body px-0 pb-2">
                            <div class="container">
                                <h6>Registro de pacientes</h6>

                                <!-- Botón para abrir el formulario -->
                                <button id="openFormBtn" class="styled-button">Crear Paciente</button>
                                ...
                                <div id="myModal" class="modal"> 
                                    ...
                                    <div class="modal-content"> 
                                        ...
                                        <!-- Formulario para ingresar información del paciente -->
                                        <div class="card">  
                                            <div class="card-body"> 
                                                <h6>Crear Nuevo Paciente</h6>
                                                
                                                <form id="formulario" method="POST" action="guardar_paciente.php">  
                                                    ...
                                                    <div style="display: inline-block; width: 45%;">
                                                        ...
                                                        <input type="text" id="remitido" name="remitido" required>
                                                    </div>  
                                                    <div class="form-group" style="display: inline-block; width: 100%;">
                                                        <label for="motivoConsulta">Motivo de Consulta:</label>
                                                        <textarea id="motivoConsulta" name="motivoConsulta" rows="4" cols="80" required></textarea>
                                                    </div>  
                                                    <button type="submit" class="styled-button">Guardar Paciente</button>
                        ...
                        <script>    
                            document.addEventListener('DOMContentLoaded', function(){   
                                ...
                                document.getElementById('formulario').addEventListener('submit', function(event) {
                                 ...
                                 function validarCampos() {
                                    ...
                                    if (!fechaValida(fechaNacimiento)) {
                                        alert('La fecha ingresada no es válida. Verifique y vuelva a intentarlo');
                                        return false;
                                    }
                                ...
                                function fechaValida(fecha){
                                    ...
                                    var month = parseInt(partesFecha[1]);
    ...
    <script src="Script.js"></script> <!-- Enlace al archivo JavaScript externo  - paciente formulario -->
</body>
