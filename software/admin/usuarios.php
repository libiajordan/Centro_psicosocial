...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/estilo_eliminar.css">
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Información de usuarios en el sistema</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            ...
                            <?php
                                ...
                                // Consulta para obtener información de todos los usuarios
                                ...
                                if ($result && $result->num_rows > 0){
                                    ...
                                    echo '<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nombre del usuario</th>';
                                    echo '<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Email</th>';
                                    echo '<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Rol</th>';
                                    echo '<th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Acciones</th>';
                                    echo '</tr>';
                                    echo '</thead>';
                                    echo '<tbody>';
                                    ...
                                    while ($row = $result->fetch_assoc()){
                                        ...
                                        echo '<button class="btn btn-sm btn-danger" onclick="abrirVentanaEliminar(' . $row["id"] . ', \'' . $row["nombre"] . '\')">Eliminar</button>';
                                        echo '</td>';
                                        echo '</tr>';
                                    }
                        ...
                        <script> 
                           function abrirVentanaEliminar(idUsuario, nombreUsuario) {
                                var confirmacion = confirm("¿Está seguro de que desea eliminar al usuario " + nombreUsuario + "?");
                                if (confirmacion) {
